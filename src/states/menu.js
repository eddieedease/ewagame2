class Menu extends Phaser.State {
  ...
  create() {
    ...
    this.background = this.game.add.sprite(0,0,'bgintro');
    ...
    //add intro text
    this.menuText = this.add.text(this.game.world.centerX,this.game.world.centerY, 'Beginbegin', {
